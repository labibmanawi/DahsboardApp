...
<div class="table_products">
    ...
    <form method="post" action="{{url('admin/user/editUser-post/'.$id)}}">

        @csrf

        <div class="mb-3">
            <label for="id" class="form-label">Id</label>
            <input name="id" type="text" class="form-control" id="id" value="{{ old('id', $userEdit->id) }}" readonly>
        </div>

        <div class="mb-3">
            <label for="name" class="form-label">Name</label>
            <input name="name" type="text" class="form-control" id="name" value="{{ old('name', $userEdit->name) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input name="email" type="email" class="form-control" id="email" aria-describedby="emailHelp" value="{{ old('email',$userEdit->email) }}">
        </div>
